...
def generate_log_entry():
    ...
    return [timestamp, src_ip, src_port_protocol, src_port,sent_packet_size, dst_ip, dst_port_protocol, dst_port,received_packet_size, machine_id, machine_name, dns_name, machine_status, machine_comment, machine_network_log, src_ip_type, dst_ip_type, packet_type, flags, duration, flow_id, num_packets, direction, network_interface, vlan_id]
...
with open('log_data.csv', 'w', newline='') as csvfile:
    ...
    writer.writerow(['Timestamp', 'Source IP', 'Source Port Protocol', 'Source Port','Sent Packet Size', 'Destination IP', 'Destination Port Protocol', 'Destination Port','Received Packet Size', 'Machine ID', 'Machine Name', 'DNS Name', 'Machine Status', 'Machine Comment', 'Machine Network Log', 'Source IP Type', 'Dest IP Type', 'Packet Type', 'Flags', 'Duration', 'Flow ID', 'Number of Packets', 'Direction', 'Network Interface', 'VLAN ID'])
